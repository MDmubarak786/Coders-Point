                    ...
                    child: InkWell(
                      onTap: () {
                        Navigator.push(
                            context,
                            new MaterialPageRoute(
                                builder: (context) => new  ContainerLabel()));
                      },
                      child: Center(
                        child: ListTile(
                    ...
                    child: InkWell(
                      onTap: () {
                        Navigator.push(
                            context,
                            new MaterialPageRoute(
                                builder: (context) => new  ColumnLabel()));
                      },
                      child: Center(
                        child: ListTile(
                          leading: ConstrainedBox(
                    ...
                    child: InkWell(
                      onTap: () {
                        Navigator.push(
                            context,
                            new MaterialPageRoute(
                                builder: (context) => new SizedBoxLabel()));
                      },
                      child: Center(
                        child: ListTile(
                          leading: ConstrainedBox(
                    ...
                    child: InkWell(
                      onTap: () {
                        Navigator.push(
                            context,
                            new MaterialPageRoute(
                                builder: (context) => new StackLabel()));
